...
if (setzone < 1) setzone = 1;
   ...
   lcd.setCursor (0,0);
   lcd.print ("Sistem expunere");
   lcd.setCursor (0,1);
   lcd.print ("cablaje (2 fete)");
   delay (2000);
   lcd.clear ();
   lcd.setCursor (0,0);
  lcd.print ("Realizare niq_ro");
  lcd.setCursor (0,1);
...
*/
 if (setzone == 1) lcd.print (" partea de jos  ");   
 if (setzone == 2) lcd.print ("pe ambele parti ");   
 if (setzone == 3) lcd.print (" partea de sus  ");
...
tone(goarna, 4000,1000);
   ...
   lcd.setCursor (0,0);
   lcd.print ("  Expunere pe   ");  
   lcd.setCursor (0,1);

if (setzone == 1) {
   digitalWrite(bec, HIGH);
   lcd.print (" partea de jos  ");   
 }
 if (setzone == 2) {
   digitalWrite(bec, HIGH);
   digitalWrite(bec2, HIGH);
   lcd.print ("pe ambele parti ");
 }   
 if (setzone == 3) {
   digitalWrite(bec2, HIGH);
   lcd.print (" partea de sus  ");
 }
